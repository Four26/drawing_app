...
// global variables woth default value
let prevMouseX,
  prevMouseY,
  snapshot,
  isDrawing = false,
...
const drawRect = (e) => {
  // creating fillColor isn't checked draw a react with border else draw rect with background
...
const startDraw = (e) => {
  ...
  prevMouseY = e.offsetY; // passing mouseY position as prevMouseY value
